    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created', models.DateTimeField(blank=True, default=main_game.models.get_datetime, null=True, validators=[main_game.models.check_created], verbose_name='created')),
                ('modified', models.DateTimeField(blank=True, default=main_game.models.get_datetime, null=True, validators=[main_game.models.check_modified], verbose_name='modified')),
                ('user', models.OneToOneField(on_delete=models.deletion.CASCADE, to=settings.AUTH_USER_MODEL, verbose_name='user')),
            ],
            options={
                'verbose_name': 'client',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created', models.DateTimeField(blank=True, default=main_game.models.get_datetime, null=True, validators=[main_game.models.check_created], verbose_name='created')),
                ('modified', models.DateTimeField(blank=True, default=main_game.models.get_datetime, null=True, validators=[main_game.models.check_modified], verbose_name='modified')),
                ('address', models.ForeignKey(on_delete=models.deletion.CASCADE, to='main_game.address', verbose_name='address')),
                ('club', models.ForeignKey(on_delete=models.deletion.CASCADE, to='main_game.club', verbose_name='club')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.UUIDField(default=uuid.uuid4, editable=False, primary_key=True, serialize=False)),
                ('created', models.DateTimeField(blank=True, default=main_game.models.get_datetime, null=True, validators=[main_game.models.check_created], verbose_name='created')),
                ('client', models.ForeignKey(on_delete=models.deletion.CASCADE, to='main_game.client', verbose_name='client')),
                ('club', models.ForeignKey(on_delete=models.deletion.CASCADE, to='main_game.club', verbose_name='club')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('modified', models.DateTimeField(blank=True, default=main_game.models.get_datetime, null=True, validators=[main_game.models.check_modified], verbose_name='modified')),
                ('club', models.ForeignKey(on_delete=models.deletion.CASCADE, to='main_game.club', verbose_name='club')),
                ('game', models.ForeignKey(on_delete=models.deletion.CASCADE, to='main_game.boardgame', verbose_name='boardgames')),
            ],
            options={
        ...
        migrations.AddField(
            ...
            name='genre',
            field=models.ForeignKey(on_delete=models.deletion.CASCADE, to='main_game.genre', verbose_name='genre'),
        ),
        migrations.AddField(
            model_name='boardgame',
            name='genres',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('modified', models.DateTimeField(blank=True, default=main_game.models.get_datetime, null=True, validators=[main_game.models.check_modified], verbose_name='modified')),
                ('game', models.ForeignKey(on_delete=models.deletion.CASCADE, to='main_game.boardgame', verbose_name='boardgames')),
                ('set', models.ForeignKey(on_delete=models.deletion.CASCADE, to='main_game.gameset', verbose_name='game_set')),
            ],
            options={
